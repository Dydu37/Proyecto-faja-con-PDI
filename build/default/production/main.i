...
void baja_tapa(void){
     LATCbits.LATC1 = 1;
     _delay((unsigned long)((2500)*(4000000/4000000.0)));
     LATCbits.LATC1 = 0;
     _delay((unsigned long)((17500)*(4000000/4000000.0)));
}
...
void sube_tapa(void){
     ...
     LATCbits.LATC1 = 0;
     _delay((unsigned long)((19500)*(4000000/4000000.0)));
}

void pone_piso(void){
    LATCbits.LATC0 = 1;
    _delay((unsigned long)((550)*(4000000/4000000.0)));
    LATCbits.LATC0 = 0;
    _delay((unsigned long)((19450)*(4000000/4000000.0)));
}
...
void main(void) {
    ...
    while(1) {
        if (PORTBbits.RB0 == 1){
            ...
            if(PORTBbits.RB2 == 1){
                 _delay((unsigned long)((940)*(4000000/4000.0)));
                    LATDbits.LATD0 = 0;
                    _delay((unsigned long)((2050)*(4000000/4000.0)));
                    switch (receivedData) {
                    case '0':
                        LATDbits.LATD4 = 0;
                    ...
                    case '1':
                        LATDbits.LATD5 = 0;
                        _delay((unsigned long)((2400)*(4000000/4000.0)));
                        LATDbits.LATD5 = 1;
                        _delay((unsigned long)((4000)*(4000000/4000.0)));
                        receivedData = '3';
                        break;
            ...
            if(PORTBbits.RB3 == 1){
                ...
                LATDbits.LATD3 = 1;
                _delay((unsigned long)((1370)*(4000000/4000.0)));
                LATDbits.LATD0 = 0;
